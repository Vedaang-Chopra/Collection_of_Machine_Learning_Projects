...
def loading():
    ...
    print("Training Data.............................")
    m1,cost1=grad_descent(x,y,learning_rate,num_iterations)
    # print("Testing Data.............................")
    ...
    for i in range(0,len(t_temp)):
        ...
        temp_data=temp_data.sum()
        temp_data1 =temp_data + m1[13]
        y_pred.append(temp_data1)
        print("upload:",temp_data1)
        temp_data=0
        temp_data1=0
...
def auto_Grad_Descent() :
    from sklearn.linear_model import SGDRegressor
    # data = np.loadtxt("data.csv", delimiter=",")
    x = np.genfromtxt(
        'G:\Development\Projects\Python Projects\Machine_Learning\Gradient_Descent\Boston_Project\\0000000000002417_training_boston_x_y_train.csv',
        delimiter=',')
    t = np.genfromtxt(
        'G:\Development\Projects\Python Projects\Machine_Learning\Gradient_Descent\Boston_Project\\0000000000002417_test_boston_x_test.csv',
        delimiter=',')
    print(x.shape, type(x))
    y = x[:, 13]
    x = x[:, 0:13]
    ...
    clf.fit(x,y)
    print(clf.coef_)
    y_pred1=clf.predict(t)
    np.savetxt('G:\Development\Projects\Python Projects\Machine_Learning\Gradient_Descent\Boston_Project\sub1.csv',
               y_pred1, fmt='%0.70f', delimiter="\n")
auto_Grad_Descent()
...
def loading():
    ...
    x=diab.data
    y=diab.target
    x = np.genfromtxt('G:\Development\Projects\Python Projects\Machine_Learning\Gradient_Descent\Power_Plant_Project\\0000000000002419_training_ccpp_x_y_train.csv',delimiter=',')
    t = np.genfromtxt('G:\Development\Projects\Python Projects\Machine_Learning\Gradient_Descent\Power_Plant_Project\\0000000000002419_test_ccpp_x_test.csv',delimiter=',')
    ...
    for i in range(0,len(t_temp)):
        temp_data=(m1[0:4]*t_temp[i])
        temp_data=temp_data.sum()
        temp_data1 =temp_data + m1[4]
        y_pred.append(temp_data1)
        # print("upload:",temp_data1)
        temp_data=0
        temp_data1=0
    np.savetxt('G:\Development\Projects\Python Projects\Machine_Learning\Gradient_Descent\Power_Plant_Project\sub.csv',y_pred, fmt='%0.70f',delimiter="\n")
loading()
